...
ME <- as.data.frame(data.table::fread("/Users/srv/beegfs/scratch/users/l/lykoskou/TE/V3/data_methylation/data_intersection/syscol_variants_methylations_5kbwindow.txt.gz",header=FALSE,stringsAsFactors=F,sep="\t"))
