...
│   ├── emods -> Contains the scripts used for the discovery of pairs of correlated TEs and genes
│   │   ├── mapping
│   │   ├── nominal
│   │   ├── permute
│   │   └── quantifications
│   ├── eqtl -> Contains the scripts used for the eQTL discovery 
│   │   ├── interaction
│   │   ├── mapping
│   │   ├── methylation
│   │   ├── nominal
...
│   │   ├── replicate
│   │   └── specific
│   └── teqtls -> Contains the scripts used for eQTL - TE - gene triplet discovery and Bayesian network analysis
│       ├── bn
│       ├── permute
│       └── triplets
